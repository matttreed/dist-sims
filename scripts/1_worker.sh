#!/bin/bash
#SBATCH --job-name=1_worker            # Job name
...
python transformer.py --wandb_project wash_big --max_local_step 10000 --num_workers 1 --learning_rate 0.0005 --cosine_anneal --save_dir outputs/transformer_4